...
<div class="flex justify-center items-center min-h-screen bg-gray-100">
    <div class="w-full max-w-lg">
        <div class="bg-white shadow-md rounded-lg p-6 mb-4">
            <h3 class="text-2xl font-semibold text-center mb-4">Edit Team</h3>
            <form class="form" action="{{ route('post.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="subjudul" name="subjudul" value="{{ $page->subjudul }}" required>
                </div>
